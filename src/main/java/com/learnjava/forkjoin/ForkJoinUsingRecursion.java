...
public class ForkJoinUsingRecursion extends RecursiveTask<List<String>> {
  ...
  public static void main(String[] args) {
    ...
    ForkJoinUsingRecursion forkJoinUsingRecursion =
        new ForkJoinUsingRecursion(names);
  ...
  protected List<String> compute() {
    ...
    ForkJoinTask<List<String>> leftInputList = new ForkJoinUsingRecursion(
        inputList.subList(0, midpoint)).fork();
